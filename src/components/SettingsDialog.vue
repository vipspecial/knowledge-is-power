          ...
          <section v-if="activeTab === 'general'" class="settings-section">
            ...
            <div class="setting-row vertical">
              <div>
                ...
                <p>标准档会随窗口大小自适应；小 / 大为固定档，保存后立即生效。</p>
              </div>
              <select id="ui-font-size" v-model="draft.general.uiFontSize">
...
.settings-nav{padding:21px 13px;border-right:1px solid #ded9cf;background:#eeebe4}.settings-brand{display:flex;align-items:center;gap:10px;padding:0 7px 20px}.settings-brand img{width:35px;height:35px;border-radius:10px}.settings-brand div{display:flex;flex-direction:column}.settings-brand strong{font-size:16px}.settings-brand span{margin-top:2px;color:#979187;font-size:var(--font-sm)}.settings-nav nav{display:grid;gap:4px}.settings-nav nav button{display:flex;height:36px;align-items:center;gap:9px;padding:0 10px;border:0;border-radius:8px;color:#69645b;background:transparent;cursor:pointer;text-align:left;font-size:var(--font-md)}.settings-nav nav button span{display:grid;width:19px;place-items:center;color:#818a82}.settings-nav nav button:hover{background:rgb(255 255 255 / 50%)}.settings-nav nav button.active{color:#344c3b;background:#fffefa;box-shadow:0 2px 8px rgb(52 47 38 / 7%);font-weight:600}
.settings-content{display:flex;min-width:0;min-height:0;flex-direction:column}.settings-content>header{display:flex;min-height:80px;align-items:center;justify-content:space-between;padding:18px 26px;border-bottom:1px solid #e8e4db}.settings-content h2,.settings-content p{margin:0}.settings-content h2{font-size:19px}.settings-content header p{margin-top:4px;color:#8d877d;font-size:var(--font-sm)}.settings-close{display:grid;width:30px;height:30px;place-items:center;border:0;border-radius:8px;color:#8b857b;background:transparent;cursor:pointer;font-size:22px}.settings-close:hover{background:#eeeae2}.settings-scroll{min-height:0;flex:1;overflow-y:auto;padding:24px 27px}.settings-section{display:grid;gap:14px}.setting-row{display:flex;align-items:center;justify-content:space-between;gap:30px;padding:17px 0;border-bottom:1px solid #ece8df}.setting-row.vertical{display:grid;gap:15px}.setting-row label,.field>span{color:#3f3b34;font-size:var(--font-lg);font-weight:600}.setting-row p{margin-top:5px;color:#969086;font-size:var(--font-sm)}.setting-row select,.field select,.field input:not([type=range]){height:37px;padding:0 10px;border:1px solid #dcd7cd;border-radius:8px;outline:0;color:#49453e;background:#fff;font-size:var(--font-md)}.setting-row input[type=range],.field input[type=range]{width:100%;accent-color:#4d6654}
.switch-row{display:flex;align-items:center;padding:15px;border:1px solid #dfe4dd;border-radius:11px;background:#f4f7f3;cursor:pointer}.switch-row>span{display:flex;min-width:0;flex:1;flex-direction:column}.switch-row strong{font-size:var(--font-lg)}.switch-row small{margin-top:4px;color:#7f887f;font-size:var(--font-sm)}.switch-row input{position:absolute;opacity:0}.switch-row i{position:relative;width:37px;height:21px;border-radius:14px;background:#c5c7c1;transition:background .15s}.switch-row i:after{position:absolute;top:3px;left:3px;width:15px;height:15px;border-radius:50%;background:#fff;box-shadow:0 1px 4px rgb(0 0 0 / 20%);content:"";transition:transform .15s}.switch-row input:checked+i{background:#52705b}.switch-row input:checked+i:after{transform:translateX(16px)}.field{display:grid;gap:7px}.ai-config{display:grid;gap:13px}.ai-config.disabled{opacity:.58}.ai-row{display:grid;grid-template-columns:1fr 1fr;gap:12px}.provider-row{display:grid;grid-template-columns:auto minmax(0,1fr);gap:12px;align-items:end}.provider-desc{color:#989187;font-size:var(--font-sm)}.field small{color:#989187;font-size:var(--font-sm);line-height:1.45}.api-key-field>div{display:flex}.api-key-field input{min-width:0;flex:1;border-radius:8px 0 0 8px!important}.api-key-field>div>button{padding:0 11px;border:1px solid #dcd7cd;border-left:0;border-radius:0 8px 8px 0;color:#69645b;background:#f3f0e9;cursor:pointer;font-size:var(--font-sm)}.clear-key{justify-self:start;padding:0;border:0;color:#a34f47;background:transparent;cursor:pointer;font-size:var(--font-sm)}.connection-test{display:flex;align-items:center;gap:11px;margin-top:7px}.connection-test button,.choose-directory{height:35px;padding:0 13px;border:1px solid #cfd8d0;border-radius:8px;color:#3e5b47;background:#eef3ee;cursor:pointer;font-size:var(--font-sm);font-weight:600}.connection-test button:disabled,.choose-directory:disabled{opacity:.55;cursor:default}.connection-test span{min-width:0;overflow:hidden;color:#7e786f;font-size:var(--font-sm);text-overflow:ellipsis;white-space:nowrap}.connection-test span.success{color:#3e7650}.connection-test span.error{color:#a34b43}
...
.mcp-bundled-note{margin:0;color:#777168;font-size:var(--font-xs);line-height:1.5}
.update-busy{align-self:center;color:var(--accent-strong);font-size:var(--font-sm);font-weight:700}.update-progress{grid-column:1/-1;height:4px!important;margin-top:7px;overflow:hidden;border-radius:99px;background:#eee8df}.update-progress i{display:block;height:100%;border-radius:inherit;background:var(--accent-solid);transition:width .18s}.update-notes{grid-column:1/-1;max-height:64px;overflow:auto;white-space:pre-line}.privacy-note{max-width:500px;margin:3px 0 0!important}
.directory-message{margin:0;color:#54715c!important;font-size:var(--font-sm)!important}
.settings-content>footer{display:flex;min-height:63px;align-items:center;justify-content:space-between;padding:12px 25px;border-top:1px solid #e8e4db}.settings-content footer>span{color:#aaa399;font-size:var(--font-sm)}.settings-content footer div{display:flex;gap:8px}.settings-content footer button{height:34px;padding:0 14px;border-radius:8px;cursor:pointer;font-size:var(--font-sm);font-weight:600}.settings-content footer .cancel{border:1px solid #ddd8cf;background:#fffefa}.settings-content footer .save{border:1px solid #4d6654;color:#fff;background:#4d6654}.settings-content footer .save:disabled{opacity:.55}
