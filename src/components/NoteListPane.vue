...
<style scoped>
.document-pane{display:flex;min-width:0;min-height:0;flex-direction:column;overflow:hidden;background:#f4f1ea}.document-pane-header{display:grid;flex:0 0 auto;gap:8px;padding:11px 10px 9px;border-bottom:1px solid #e0dbd1}.document-pane-title{display:flex;height:27px;align-items:center;justify-content:space-between;padding:0 2px}.document-pane-title>div:first-child{display:flex;min-width:0;align-items:baseline;gap:7px}.document-pane-title strong{overflow:hidden;color:#4a463f;font-size:12px;text-overflow:ellipsis;white-space:nowrap}.document-pane-title small{color:#999288;font-size:9px;white-space:nowrap}.list-mode-switch{display:flex;padding:2px;border:1px solid #ded9cf;border-radius:7px;background:#ece9e2}.list-mode-switch button{display:grid;width:25px;height:22px;place-items:center;padding:0;border:0;border-radius:5px;color:#89837a;background:transparent;cursor:pointer;font-size:12px}.list-mode-switch button.active{color:#405948;background:#fffefa;box-shadow:0 1px 3px rgb(52 47 38 / 10%)}.document-create-row{display:flex;gap:6px}.document-create{display:flex;height:34px;min-width:0;flex:1;align-items:center;gap:7px;padding:0 10px;border:0;border-radius:8px;color:#fff;background:#4d6654;cursor:pointer;font-size:11px;font-weight:650}.document-create:hover{background:#405948}.document-create span{font-size:15px}.document-create kbd{margin-left:auto;color:rgb(255 255 255 / 60%);font-size:9px}.child-create{width:39px;height:34px;border:1px solid #d7d2c8;border-radius:8px;color:#53675a;background:#fffefa;cursor:pointer;font-size:12px}.child-create:hover{border-color:#aeb9b0;background:#eef3ee}.document-search{display:flex;height:33px;align-items:center;gap:7px;padding:0 9px;border:1px solid #ddd8ce;border-radius:8px;color:#8e887e;background:rgb(255 255 255 / 62%)}.document-search:focus-within{border-color:#819386;box-shadow:0 0 0 2px rgb(77 102 84 / 9%)}.document-search svg{width:14px;height:14px;fill:none;stroke:currentColor;stroke-linecap:round;stroke-width:1.8}.document-search input{min-width:0;flex:1;border:0;outline:0;color:#3c3832;background:transparent;font-size:11px}.document-search input::-webkit-search-cancel-button{display:none}.document-search kbd{color:#a19b91;font-size:9px}.document-list{min-height:0;flex:1;overflow-y:auto;overscroll-behavior:contain;padding:7px}.document-list::-webkit-scrollbar{width:8px}.document-list::-webkit-scrollbar-thumb{border:3px solid transparent;border-radius:8px;background:#c5bfb4;background-clip:padding-box}.document-row{position:relative;display:flex;min-width:0;align-items:flex-start;margin-left:calc(var(--tree-depth) * 10px);border-radius:9px}.document-row:hover{background:rgb(255 255 255 / 54%)}.document-row.active{background:#fffefa;box-shadow:inset 2px 0 #5b7662,0 2px 8px rgb(59 50 37 / 5%)}.branch-toggle,.branch-spacer{display:grid;width:19px;height:30px;flex:0 0 auto;place-items:center;padding:0;border:0;color:#8b857b;background:transparent;font-size:15px}.branch-toggle{cursor:pointer}.branch-toggle:hover{color:#405948}.branch-spacer{color:#b7b0a5;font-size:10px}.document-select{display:block;min-width:0;flex:1;padding:8px 6px 8px 1px;border:0;color:#49453e;background:transparent;cursor:pointer;text-align:left}.document-title-line{display:flex;min-width:0;align-items:baseline;gap:6px}.document-title-line strong{min-width:0;flex:1;overflow:hidden;font-size:12px;text-overflow:ellipsis;white-space:nowrap}.document-title-line time{flex:0 0 auto;color:#9b958b;font-size:9px}.pin{color:#59705f;font-size:7px}.document-select p{margin:4px 0 0;overflow:hidden;color:#827c72;font-size:10px;line-height:1.45;text-overflow:ellipsis;white-space:nowrap}.document-tags{display:flex;gap:5px;margin-top:5px;overflow:hidden}.document-tags span{overflow:hidden;color:#718076;font-size:9px;text-overflow:ellipsis;white-space:nowrap}.row-child-create{width:24px;height:28px;flex:0 0 auto;margin:3px 3px 0 0;padding:0;border:0;border-radius:6px;color:#7b887e;background:transparent;cursor:pointer;font-size:14px;opacity:0}.document-row:hover .row-child-create,.document-row.active .row-child-create{opacity:1}.row-child-create:hover{color:#405948;background:#e8ede8}.mode-outline{padding-top:6px}.mode-outline .document-row{height:31px;align-items:center;border-radius:7px}.mode-outline .document-select{height:31px;padding:0 4px 0 1px}.mode-outline .document-title-line{align-items:center}.mode-outline .document-title-line strong{font-size:11px;font-weight:560}.mode-outline .row-child-create{margin-top:0}.document-list-message{display:grid;min-height:150px;place-content:center;gap:8px;color:#999287;text-align:center;font-size:11px}.document-list-message button{border:0;color:#48614e;background:transparent;cursor:pointer;font-size:10px}
